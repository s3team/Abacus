...
namespace tana{
    ...
    private:
        ...
        uint32_t m_ret_value;
    public:
        LIBC_X86_Memcpy(uint32_t destination, uint32_t source, uint32_t num, uint32_t ret_value) : Inst_Base(false)
        {
    ...
    private:
        ...
        uint32_t m_ret_value;
    public:
        LIBC_X86_Mempcpy(uint32_t destination, uint32_t source, uint32_t num, uint32_t ret_value) : Inst_Base(false)
        {
            m_destination = destination;
            m_source = source;
            m_num = num;
    ...
    private:
        ...
        uint32_t m_ret_value;
    public:
        LIBC_X86_Memset(uint32_t ptr, uint32_t value, uint32_t num, uint32_t ret_value) : Inst_Base(false)
        {
            m_ptr = ptr;
            m_value = value;
            m_num = num;
