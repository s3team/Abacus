...
std::string function_name, end_function_name;
FILE *fp;
...
VOID Routine(RTN rtn, VOID *v) {
    ...
    if (rtn_name.find(end_function_name) != std::string::npos) {
...
int main(int argc, char *argv[]) {
    ...
    function_name = "mbedtls_pk_parse_key";
    end_function_name = "mbedtls_pk_decrypt";
